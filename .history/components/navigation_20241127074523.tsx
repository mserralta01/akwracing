        ...
        <div className="hidden md:flex space-x-8">
          <NavigationMenu>
            <NavigationMenuList className="flex space-x-8">
              <NavigationMenuItem>
                <NavigationMenuTrigger className="text-white text-lg font-medium hover:text-racing-red">
                  Programs
                </NavigationMenuTrigger>
                <NavigationMenuContent>
              ...
              <NavigationMenuItem>
                <Link href="/facilities" legacyBehavior passHref>
                  <NavigationMenuLink className="text-white text-lg font-medium hover:text-racing-red">
                    Facilities
                  </NavigationMenuLink>
                </Link>
              </NavigationMenuItem>
